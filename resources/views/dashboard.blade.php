<x-layout>
    ...
    {{-- <style>
        .latar {
            background-color: rgb(213, 47, 146);
        }
    </style> --}}
    ...
    <section class="latar">
        ...
        <div class="text-center">
            ...
            <h1
                class="text-5xl font-extrabold mb-4 mt-8 text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600">
                Selamat Datang Di Website
            </h1>

            <h1
                class="text-5xl font-extrabold mb-4 mt-8 text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                SPK Copras
            </h1>

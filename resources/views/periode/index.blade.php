<x-layout>
    <div class="container mx-auto mt-8">
        ...
        <!-- Tombol Cetak -->
        <button onclick="printTable('{{ request('periode') }}')" class="mb-4 px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-200 ease-in-out">
            Cetak
        </button>
